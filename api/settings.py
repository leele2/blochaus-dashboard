...
CACHES = {
    "default": {
        ...
        "LOCATION": getenv("REDIS_URL"),  # this pulls from your .env
        "OPTIONS": {
            "CLIENT_CLASS": "django_redis.client.DefaultClient",
            "SSL": True,  # since you're using rediss://
        },
    }
}
...
STATICFILES_DIRS = [
    BASE_DIR
    / "dev_static",  # This allows Django to look for static files in the 'static' directory
]
